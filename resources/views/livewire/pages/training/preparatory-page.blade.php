...
#[Title('Přípravka | Judo Club Raion-ryu')]
...
<section class="relative bg-gradient-to-br from-surface via-surface-container-low to-surface-container overflow-hidden">
    <div class="absolute inset-0 flex items-center justify-end pr-8 md:pr-16 pointer-events-none select-none" aria-hidden="true">
        <span class="font-headline text-[12rem] md:text-[18rem] font-black text-primary opacity-[0.04] leading-none">準</span>
    </div>
    <div class="container mx-auto px-6 md:px-8 py-16 md:py-24 relative z-10">
        <div class="max-w-2xl">
            ...
            <p class="text-on-surface-variant text-lg leading-relaxed">
                {{ $content['preparatory']['name'] }} — {{ $content['preparatory']['age'] }}
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-6 md:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            ...
            <div class="lg:col-span-2">
                <p class="text-xs font-bold tracking-[0.3em] uppercase text-primary mb-4">{{ $content['preparatory']['name'] }}</p>
                ...
                <p class="text-on-surface-variant text-lg leading-relaxed mb-8">
                    {{ $content['preparatory']['description'] }}
                </p>

                <div class="flex flex-col gap-4">
                    <div class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-primary text-xl shrink-0 mt-0.5">child_care</span>
                        <div>
                            <span class="font-bold text-on-surface text-sm">Věková skupina</span>
                            <p class="text-on-surface-variant text-sm">{{ $content['preparatory']['age'] }}</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-on-surface-variant text-sm">Základy juda, pohybové dovednosti, koordinace a herní forma tréninku</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                    ...
                    <div class="flex flex-col gap-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-on-surface">{{ $content['preparatory']['days'] }}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-bold text-on-surface">{{ $content['preparatory']['time'] }}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
    ...
    <div class="container mx-auto px-6 md:px-8 relative z-10">
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
                ...
                <p class="text-on-primary opacity-70 text-sm mt-2">
                    {{ $content['kimono_note'] }}
                </p>
            </div>
            <a
