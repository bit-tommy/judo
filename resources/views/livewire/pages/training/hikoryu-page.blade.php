...
#[Title('HIKO-RYU TAIJUTSU | Judo Club Raion-ryu')]
    ...
    <div class="container mx-auto px-6 md:px-8">
        ...
        <div class="max-w-3xl">
            ...
            <h2 class="font-headline text-3xl md:text-4xl font-extrabold text-on-surface tracking-tight mb-6">
                O programu Hiko-ryu Taijutsu
            </h2>
            <p class="text-on-surface-variant text-lg leading-relaxed mb-8">
                Hiko-ryu Taijutsu je systém bojového umění vyučovaný v rámci Judo Club Raion-ryu.
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-error font-bold text-sm">{{ $content['hikoryu']['status'] }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-6 md:px-8">
        <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="text-on-surface-variant mb-8 leading-relaxed">
                Kontaktujte nás a budeme vás informovat, jakmile tréninky Hiko-ryu Taijutsu budou obnoveny.
